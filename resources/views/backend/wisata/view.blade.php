        ...
        <div class="box-body">
            <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
        <a href="{{ route('backend.wisata.add') }}" style="float: right;" type="button" class="btn btn-primary mb-5">Add wisata</a>
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nama</th>
                ...
                <tbody>
                    @foreach ($allwisata as $key => $wisata)
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/images') }}/{{ $wisata->gambar }}" width="100" height="100" alt="{{ $wisata->gambar }}"></td>
                            <td>
