       ...
       <!-- Basic Forms -->
        <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title">Add Budaya</h4>
          ...
          <div class="box-body">
            <div class="row">
              <div class="col">
                  <form method="post" action="{{route('budayas.store')}}">
                    @csrf
                      <div class="row">
                          <div class="col-md-6">
                          <div class="form-group">
                              <h5>nama_kuliner<span class="text-danger">*</span></h5>
                              <div class="controls">
                                  <input type="text" name="nama_budaya" class="form-control" required data-validation-required-message="This field is required"> </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="gambar" class="form-control" required data-validation-required-message="This field is required"> </div>
