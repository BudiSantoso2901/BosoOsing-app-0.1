       ...
       <!-- Basic Forms -->
        <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title">Add indo</h4>
          ...
          <div class="box-body">
            <div class="row">
              <div class="col">
                  <form method="post" action="{{route('bahasa.store')}}">
                    @csrf
                      <div class="row">
                          <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <div class="controls">
                                  <input type="text" name="kata" class="form-control" required data-validation-required-message="This field is required"> </div>
